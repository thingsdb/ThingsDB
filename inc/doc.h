...
#define DOC_TUPLE_SORT              DOC_SEE("data-types/tuple/sort")
...
#define DOC_TYPE_VALUES             DOC_SEE("data-types/Type/values")
#define DOC_TYPE_WRAP               DOC_SEE("data-types/Type/wrap")
