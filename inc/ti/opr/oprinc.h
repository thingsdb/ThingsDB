...
typedef enum
{
    ...
    OPR_NIL_ENUM            =TI_VAL_NIL<<4|TI_VAL_ENUM,
    ...
    OPR_INT_ENUM            =TI_VAL_INT<<4|TI_VAL_ENUM,
    ...
    OPR_FLOAT_ENUM          =TI_VAL_FLOAT<<4|TI_VAL_ENUM,
    ...
    OPR_BOOL_ENUM           =TI_VAL_BOOL<<4|TI_VAL_ENUM,
    ...
    OPR_MP_ENUM             =TI_VAL_MP<<4|TI_VAL_ENUM,
    ...
    OPR_NAME_ENUM           =TI_VAL_NAME<<4|TI_VAL_ENUM,
    ...
    OPR_STR_ENUM            =TI_VAL_STR<<4|TI_VAL_ENUM,
    ...
    OPR_BYTES_ENUM          =TI_VAL_BYTES<<4|TI_VAL_ENUM,
    ...
    OPR_REGEX_ENUM          =TI_VAL_REGEX<<4|TI_VAL_ENUM,
    ...
    OPR_THING_ENUM          =TI_VAL_THING<<4|TI_VAL_ENUM,
    ...
    OPR_WRAP_ENUM           =TI_VAL_WRAP<<4|TI_VAL_ENUM,
    ...
    OPR_ARR_ENUM            =TI_VAL_ARR<<4|TI_VAL_ENUM,
    ...
    OPR_SET_ENUM            =TI_VAL_SET<<4|TI_VAL_ENUM,
    ...
    OPR_CLOSURE_ENUM        =TI_VAL_CLOSURE<<4|TI_VAL_ENUM,
    ...
    OPR_ERROR_ENUM          =TI_VAL_ERROR<<4|TI_VAL_ENUM,

    OPR_ENUM_NIL           =TI_VAL_ENUM<<4|TI_VAL_NIL,
    OPR_ENUM_INT           =TI_VAL_ENUM<<4|TI_VAL_INT,
    OPR_ENUM_FLOAT         =TI_VAL_ENUM<<4|TI_VAL_FLOAT,
    OPR_ENUM_BOOL          =TI_VAL_ENUM<<4|TI_VAL_BOOL,
    OPR_ENUM_MP            =TI_VAL_ENUM<<4|TI_VAL_MP,
    OPR_ENUM_NAME          =TI_VAL_ENUM<<4|TI_VAL_NAME,
    OPR_ENUM_STR           =TI_VAL_ENUM<<4|TI_VAL_STR,
    OPR_ENUM_BYTES         =TI_VAL_ENUM<<4|TI_VAL_BYTES,
    OPR_ENUM_REGEX         =TI_VAL_ENUM<<4|TI_VAL_REGEX,
    OPR_ENUM_THING         =TI_VAL_ENUM<<4|TI_VAL_THING,
    OPR_ENUM_WRAP          =TI_VAL_ENUM<<4|TI_VAL_WRAP,
    OPR_ENUM_ARR           =TI_VAL_ENUM<<4|TI_VAL_ARR,
    OPR_ENUM_SET           =TI_VAL_ENUM<<4|TI_VAL_SET,
    OPR_ENUM_CLOSURE       =TI_VAL_ENUM<<4|TI_VAL_CLOSURE,
    OPR_ENUM_ERROR         =TI_VAL_ENUM<<4|TI_VAL_ERROR,
    OPR_ENUM_ENUM          =TI_VAL_ENUM<<4|TI_VAL_ENUM,
} ti_opr_perm_t;
