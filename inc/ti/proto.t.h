...
typedef enum
{
    ...
    TI_PROTO_NODE_ERR_TIMER     =134,   /* [timer_id, next_ts, err_code, err_msg] */
    TI_PROTO_NODE_FIN_TIMER     =133,   /* [timer_id, next_ts] */
    /*
    ...
    TI_PROTO_NODE_REQ_TIMER     =162,   /* [scope_idtimer_iduser_id, [original]] */
