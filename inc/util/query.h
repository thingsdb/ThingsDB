...
static inline _Bool query_val_is_thing(ti_query_t * query);
static inline _Bool ___query_in_use_thing(ti_query_t * query);
...
static inline ti_val_t * query_pop_val(ti_query_t * query)
{
