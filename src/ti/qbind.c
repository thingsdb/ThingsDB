...
#include <ti/fn/fnwhitelistadd.h>
#include <ti/fn/fnwhitelistdel.h>
 ...
 * Command:
 *
 *    pcregrep -o1 '\.name\=\"(\w+)' qbind.c | gperf -E -k '*,1,$' -m 400
 */
enum
{
    TOTAL_KEYWORDS = 286,
        ...
        register size_t n)
{
    static unsigned short asso_values[] =
    {
        ...
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821,   1,   1,
        1, 821,   3, 821,   3, 821,   3, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821,   1, 821,  21,  89,  94,
        18,   5, 101, 416, 222,   1,  13,  65,  29,  60,
        10,  48, 181,  66,   6,   1,   2,  66,  53, 278,
        239, 115,  68, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
        821, 821, 821, 821, 821, 821, 821, 821, 821, 821,
...
qbind__fmap_t qbind__fn_mapping[TOTAL_KEYWORDS] = {
    ...
    {.name="backups_ok",        .fn=do__f_backups_ok,           ROOT_NE},
    ...
    {.name="bit_count",         .fn=do__f_bit_count,            CHAIN_NE},
    ...
    {.name="is_module",         .fn=do__f_is_module,            ROOT_NE},
    ...
    {.name="is_tel",            .fn=do__f_is_tel,               ROOT_NE},
    ...
    {.name="whitelist_add",     .fn=do__f_whitelist_add,        ROOT_TE},
    {.name="whitelist_del",     .fn=do__f_whitelist_del,        ROOT_TE},
